...
public class squelettePorte : MonoBehaviour
{
    /*=======================
              Variables
      =========================*/
    ...
    void Update()
    {
        ...
        ========================================*/
        //Pour debugger la Vie du squelette
        //print(Vie);
        //Pour debugger le booleen qui determine si la partie est finie ou non
        //print(finPartie);
        //Pour remettre les points de vie du squelette a 20 on regarde si la partie est bien terminee
        ...
        //Pour degbugger et savoir la distance calculee entre le personnage et l'ennemi
        //print(distance);
        //print(Vie);
